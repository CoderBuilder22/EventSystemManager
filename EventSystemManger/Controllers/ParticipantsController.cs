...
namespace EventSystemManger.Controllers
{
    public class ParticipantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ParticipantId,FirstName,LastName,Email,PhoneNumber")] Participant participant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ParticipantId,FirstName,LastName,Email,PhoneNumber")] Participant participant)
        {
